...
#creating a function frame to take input values from gui wrapper
def process_video (video_file, output_file, threshold_input):
    ...
    threshold = threshold_input  # you may need to adjust this value
    ...
    with pd.ExcelWriter(output_file + "/movement_log.xlsx") as writer:
